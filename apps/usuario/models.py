...
class Usuario(AbstractBaseUser, PermissionsMixin):
    ...
    rut = models.CharField('Rut', max_length=9, unique= True)
    ...
    def save(self,*args, **kwargs):
        ...
        En este caso lo utlizamos para formlaizar los atributos del usuario 
        En la instancia antes del guardado.
        """
        if not self.cargo:
            self.is_staff = False
        self.is_staff = True
...
class AdminManager(models.Manager):
    def get_queryset(self,*args, **kwargs):
        """Se realiza una consulta en base al padre usuario donde se le da el cargo correspondiente"""
